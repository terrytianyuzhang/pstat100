...
```{r}
std_dev_pop_diameter = #... your code here
...
mean_sample_diameter <- #... your code here

# Display the result
print(mean_sample_diameter)
```
...
```{r}
mean_sample2_diameter <- #... your code here
...
```{r}
proportion_hawks_sample = ...#your code here
...
# compute mean
sample_hawks_biased_mean <- ...#your code here
...
(Type your answer in text here (if needed))
